...
unless they have been marked as favorites.
...
def cleanup_old_results():
    ...
    Favorited results are preserved indefinitely.
    
    This task:
    1. Calculates the cutoff date (today - 14 days)
    2. Finds all non-favorited results older than the cutoff
    3. Deletes them
    4. Logs the count
    """
    db = SessionLocal()
    try:
        ...
        old_results = db.query(ScrapeResult).filter(
            and_(
